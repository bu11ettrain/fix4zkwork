...
#################################################################################################################################################
#It should be fixed inside miner (you just need to implement correct an exception handling and stop miner instead of send error message continously). 
...
echo "$(date +"%Y-%m-%d %H:%M:%S") GPU FAULT" >> /home/user/gpu_fault.log && \
